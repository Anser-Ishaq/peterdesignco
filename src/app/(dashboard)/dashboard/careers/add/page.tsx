...
export default function AddCareerPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold text-gray-900">Add Career Opportunity</h1>
      
      <div className="bg-white rounded-lg shadow p-6">
        <p className="text-gray-600 mb-6">Create a new job posting for your organization.</p>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Dates and Status</h3>
