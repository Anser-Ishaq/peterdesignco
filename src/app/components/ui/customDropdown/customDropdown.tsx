...
const CustomDropdown = ({ 
    options = ['Default Sorting', 'Price: Low to High', 'Price: High to Low', 'Newest First'],
    ...
    return (
        <div className="relative w-[200px]">
            <button
                ...
                className="w-full h-[50px] flex items-center justify-between px-5 py-3.5 border border-gray bg-transparent cursor-pointer"
            >
